...
Feature: Entrance Exam Functionality
  ...
  Scenario Outline: Create and Delete a Exam
    ...
    Examples:
      | ExamName     | AcademicPeriodOption | GradeLevelOption |
      | Kim1 exam is | academicPeriod2      | gradeLevel4      |
      | Fiz1 exam is | academicPeriod2      | gradeLevel3      |
      | Geo1 exam is | academicPeriod2      | gradeLevel2      |
      | Kod1 exam is | academicPeriod2      | gradeLevel1      |
